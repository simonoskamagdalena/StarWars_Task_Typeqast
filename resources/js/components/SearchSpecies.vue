<template>
    <div>
        ...
        <div v-if="data">
            <center>
                <p class="filter">
                    Species search results for <b>{{key}}</b>
                </p>
                <div>
                    <table id="table_characters" class="display">
                        ...
                        <tbody>
                        <tr v-for="specie in data">
                            <td colspan="2">
                                <router-link :to="{path:'/species-info?id='+specie.id}">
                                    {{specie.name}}
                                </router-link>
                            </td>
                        </tr>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                axios.get('/api/search-species?page=' + this.page + '&search=' + this.key).then(res => {
                    console.log(res)
