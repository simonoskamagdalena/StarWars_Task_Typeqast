<template>
    <div>
        ...
        <div v-if="data">
            <center>
                <p class="filter">
                    Characters search results for <b>{{key}}</b>
                </p>
                <div>
                    <table id="table_characters" class="display">
                        ...
                        <tbody>
                        <tr v-for="character in data">
                            <td colspan="2">
                                <router-link :to="{path:'/character?id='+character.id}">
                                    {{character.name}}
                                </router-link>
                            </td>
                        </tr>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                axios.get(`/api/search-people?page=${this.page}&search=${this.key}`).then(res => {
                    console.log(res)
